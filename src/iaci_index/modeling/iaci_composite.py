...
PRETTY_OUTPUT_FILE = "step5_A12_IACI_final_4D_pretty.xlsx"
...
def prettify_scores() -> None:
    ...
    df.to_excel(PRETTY_OUTPUT_FILE, index=False)
    print(f"已保存展示版指数表：{PRETTY_OUTPUT_FILE}")


def compute_iaci_4d() -> None:
    main()
